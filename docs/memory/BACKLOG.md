...
- [x] Haven safe village, separate exploration with five enemies.
- [x] Click-to-approach combat with three ability/math tiers.
- [x] Falling easy comparison minigame, relaxed mode, untimed powerful spells.
- [x] Inventory, meaningful equipment stats, loot rarity, XP/levels/gold.
- [x] Quest giver/reward, village recovery, repeated expeditions.
- [x] Locally bundled thematic fonts and redesigned HUD / inventory.
- [x] Executable launcher created.
- [x] Specialist fleet used, independent maths review recorded.
...
- [ ] Working village forge/shop economy, active topic-affinity effects, loot wear/rotation and skill tree.
- [ ] Long division step workspace, more topic templates and reviewed 11+ coverage.
